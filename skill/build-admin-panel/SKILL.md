...
Work through these six phases in order. Phases 1–2 are pure research and
judgment calls — do not write implementation code yet. Phases 3–6 build,
...
2. Spawn 1–3 parallel Explore agents (read-only) to research the backend and
