...
- Any **invite/onboarding flow** — check exactly what it provisions. It's
  ...
  set, but never the actual profile/entity document — the invited user
...
anything. Each one materially changes scope — don't default silently.
...
4. **For any entity that belongs to a user/tenant: "Can an admin create a
   ...
   who already have the right role, via search — smallest new-logic
